...
Acknowledgements go to the Virtual Radar Server contributors Decentrafly.org API # We contribute some code.
...
`}),e.add({id:19,href:"/website/docs/overview/status/",title:"Status",description:"Uptime Status #",content:"Uptime Status # "}),e.add({id:20,href:"/website/docs/open-data/",title:"Open Data",description:"Decentrafly.org open data.",content:""}),e.add({id:21,href:"/website/docs/hardware/",title:"Hardware",description:"Recommended hardware",content:""}),e.add({id:22,href:"/website/docs/acknowledgements/",title:"Acknowledgements",description:"Decentrafly.org acknowledgements.",content:""}),e.add({id:23,href:"/website/docs/",title:"Docs",description:"Decentrafly.org docs.",content:""}),search.addEventListener("input",t,!0);function t(){const s=5;var n=this.value,o=e.search(n,{limit:s,enrich:!0});const t=new Map;for(const e of o.flatMap(e=>e.result)){if(t.has(e.doc.href))continue;t.set(e.doc.href,e.doc)}if(suggestions.innerHTML="",suggestions.classList.remove("d-none"),t.size===0&&n){const e=document.createElement("div");e.innerHTML=`No results for "<strong>${n}</strong>"`,e.classList.add("suggestion__no-results"),suggestions.appendChild(e);return}for(const[r,a]of t){const n=document.createElement("div");suggestions.appendChild(n);const e=document.createElement("a");e.href=r,n.appendChild(e);const o=document.createElement("span");o.textContent=a.title,o.classList.add("suggestion__title"),e.appendChild(o);const i=document.createElement("span");if(i.textContent=a.description,i.classList.add("suggestion__description"),e.appendChild(i),suggestions.appendChild(n),suggestions.childElementCount==s)break}}})()